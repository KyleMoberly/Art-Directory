...
<asp:Content ID="DefaultContent" runat="server" ContentPlaceHolderID="MainContent">    
    ...
    <br />
    Categories:<br />
    <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="CategoryDataSource">
        <Columns>
    ...
    <div>  &nbsp;&nbsp; Projects:<br />
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
            ...
            DataKeyNames="Name,PrimaryKey,PhoneNumber,Email,AddressOne,AddressTwo,City,Zipcode,IsActive,IsFeatured,DateLastModified,URL,ImagePath,Description">
            <Columns>
       ...
       <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetAllArtListings"
            ...
            DataObjectTypeName="LogicDAL.IArtListing" DeleteMethod="DeleteArtListing" 
            UpdateMethod="UpdateArtListing"></asp:ObjectDataSource>
       <br />
