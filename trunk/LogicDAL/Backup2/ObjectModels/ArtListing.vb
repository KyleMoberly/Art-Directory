Public Class ArtListing : Implements IArtListing
    ...
    Public Property Person() As String Implements IArtListing.Person
        Get
            Return _person
        End Get
        Set(ByVal value As String)
    ...
    Public Property PrimaryKey() As Integer Implements IArtListing.PrimaryKey
        Get
            Return _primaryKey
        End Get
    ...
    Public Property State() As String Implements IArtListing.State
        Get
            Return _state
        End Get
        Set(ByVal value As String)
